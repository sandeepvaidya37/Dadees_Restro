    ...
    <div className='login-pop-up'>
          <form onSubmit={onLogin} className='login-popup-container'>
            ...
            <div className="login-popup-inputs">
                ...
                {currState==="Login"?<p>Create a New account? <span onClick={()=>setCurrState("Sign Up")}>Click here</span></p>:<p>Alreay have an account? <span onClick={()=>setCurrState("Login")}>Login here</span></p>}
